...
Try	
	...
	if is_canal_distribuicao <> 'LF' and is_canal_distribuicao <> 'EC' Then
		as_log = 'Canal de distribui$$HEX2$$e700e300$$ENDHEX$$o ['+ is_canal_distribuicao + '] est$$HEX2$$e1002000$$ENDHEX$$diferente do esperado [LF - Loja F$$HEX1$$ed00$$ENDHEX$$sica; EC - eCommerce].'
		return false
	end if
	...
	Choose Case is_organizacao_venda
		...
		Case Else
			...
			as_log = "O valor [" + is_organizacao_venda + "] informado para o campo CD_ORGANIZACAO_VENDA n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$v$$HEX1$$e100$$ENDHEX$$lido."	
			return false
	...
	if is_canal_distribuicao = 'LF' then
		...
		if il_filial_legado > 0 Then
			...
			if ll_existe = 0 or isnull(ll_existe) Then
				as_log = 'A filial [' + string(il_filial_legado) + '] n$$HEX1$$e300$$ENDHEX$$o possui o administrativo integrado ao SAP ou est$$HEX2$$e1002000$$ENDHEX$$com situa$$HEX2$$e700e300$$ENDHEX$$o inativa.'
				return false
			end if
	...
	if is_domicilio_fiscal <> '' and not isnull(is_domicilio_fiscal) Then
		...
		where c.cd_cidade_ibge = :is_domicilio_fiscal
			...
			If ll_existe = 0 or isnull(ll_existe) Then
				as_log = 'N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$filiais relacionados ao c$$HEX1$$f300$$ENDHEX$$digo IBGE [' + is_domicilio_fiscal + '] da rede [' + is_organizacao_venda + '].'
				return false
			end if
	...
	if ( is_domicilio_fiscal <> '' and not isnull(is_domicilio_fiscal) ) or ( il_filial_legado > 0 ) Then
		...
		//Se a vig$$HEX1$$ea00$$ENDHEX$$ncia do pre$$HEX1$$e700$$ENDHEX$$o j$$HEX2$$e1002000$$ENDHEX$$terminou, ignora o registro e passa para o pr$$HEX1$$f300$$ENDHEX$$ximo.
...
//		as_log = 'A UF da filial ecommerce [' + ls_cd_uf_ecommerce + '] est$$HEX2$$e1002000$$ENDHEX$$diferente da UF recebida do SAP [' + is_UF + '].'
//		return false
//	End if
...
//			End If
		...
		// Pega o pre$$HEX1$$e700$$ENDHEX$$o de venda de SC e replica para os demais estados, este processo $$HEX2$$e9002000$$ENDHEX$$igual ao que t$$HEX1$$ed00$$ENDHEX$$nhamos no legado,
		// agora os pre$$HEX1$$e700$$ENDHEX$$os de venda s$$HEX2$$f3002000$$ENDHEX$$podem ser cadastrados no SAP		
		If is_UF = 'SC' Then
			//	Come$$HEX1$$e700$$ENDHEX$$a a valer assim que o pre$$HEX1$$e700$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$atualizado, pois isso s$$HEX2$$f3002000$$ENDHEX$$vai acontecer quando for um 
			//	produto novo, mesmo que j$$HEX2$$e1002000$$ENDHEX$$acontece no legado.
			update produto_uf
