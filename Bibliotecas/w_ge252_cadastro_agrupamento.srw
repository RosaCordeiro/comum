...
Choose Case ls_Tipo
	Case "1" //Controlados
		...
		If ll_Qtde > 0 Then
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Esse agrupamento n$$HEX1$$e300$$ENDHEX$$o pode ser do tipo CONTROLADO.~rJ$$HEX2$$e1002000$$ENDHEX$$tem produto que n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$controlado cadastrado para ele.")
			Return False
		End If
	Case "2"//N$$HEX1$$e300$$ENDHEX$$o controlados
		...
		If ll_Qtde > 0 Then
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Esse agrupamento n$$HEX1$$e300$$ENDHEX$$o pode ser do tipo N$$HEX1$$c300$$ENDHEX$$O CONTROLADO.~rJ$$HEX2$$e1002000$$ENDHEX$$tem produto controlado cadastrado para ele.")
			Return False
		End If
	...
	If ls_Fornecedor <> ls_Fornecedor_Select Then
		...
		Else
			...
			If Not gvo_Aplicacao.ivo_Seguranca.of_Libera_Acesso_Procedimento("W_GE252_ALTERAR_FORNECEDOR_AGRUPAMENTO", ref ls_Matricula) Then 
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Voc$$HEX2$$ea002000$$ENDHEX$$n$$HEX1$$e300$$ENDHEX$$o tem permiss$$HEX1$$e300$$ENDHEX$$o para alterar o fornecedor do agrupamento quando h$$HEX2$$e1002000$$ENDHEX$$produtos no agrupamento.")
				Return False
			End If
		End If
	End If
