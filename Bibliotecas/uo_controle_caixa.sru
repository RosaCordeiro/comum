...
Choose Case SqlCa.SqlCode
	...
	Case 100
		IF pb_showmessage THEN
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O caixa '" + ps_Caixa + "' n$$HEX1$$e300$$ENDHEX$$o est$$HEX2$$e1002000$$ENDHEX$$aberto.", Exclamation!, Ok!)
		END IF
		Return -1
	Case -1
		IF pb_showmessage THEN
...
If lvb_Retorno Then
	...
	If pl_conta_parcial = 0 Then //Continua a gravar como sempre gravou
		If ps_especie = 'NFC' or ps_especie = 'SAT' Then  //Para vendas NFC-e/SAT a conta de pagamento parcial de conv$$HEX1$$ea00$$ENDHEX$$nio $$HEX2$$e9002000$$ENDHEX$$a 212
...
If lvs_Recibo <> "" Then	
	...
	lvb_Retorno = of_Insere_Recibo_Cobranca( lvs_Recibo				, & 
															 ...
															 ps_Responsavel		, &
															 lvi_Tipo_Recibo		, &
					/* N$$HEX2$$ba002000$$ENDHEX$$T$$HEX1$$ed00$$ENDHEX$$tulo */						 lvs_Titulo				, &
															 ps_nome_cliente		, &  
															 ps_nr_cheque			, &
															 ps_nome_banco		, &
															 lvl_Filial_Venda		, &
...
Choose Case SqlCa.SqlCode
	Case 0
		...
		Return True
	Case 100
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Caixa geral n$$HEX1$$e300$$ENDHEX$$o localizado ou j$$HEX2$$e1002000$$ENDHEX$$finalizado para a filial '" + String(pl_Filial) + "'.", StopSign!)
		Return False
	Case -1
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro na localiza$$HEX2$$e700e300$$ENDHEX$$o do caixa geral." + SqlCa.SqlErrText, StopSign!)
		Return False
