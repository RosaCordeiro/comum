...
public function boolean of_verifica_contrato (string ps_cartao, ref long pl_convenio, ref datastore pds_contratos);//Busca contratos ativos para Descontos de Plano de Saude e verifica se a carteirinha est$$HEX2$$e1002000$$ENDHEX$$em algum.
String ls_bin
Long ll_convenio
String ls_convenios
...
//Convenio do contrato estar$$HEX2$$e1002000$$ENDHEX$$nos parametros
...
//			End If
			...
			If This.of_is_convenio_unimed_injetaveis( al_Convenio ) Then
				...
				End If
			Else
				If LeftA(as_cartao,4) = '0027' Then //Verifica Cart$$HEX1$$e300$$ENDHEX$$o Unimed Joinville se $$HEX2$$e9002000$$ENDHEX$$de contratos da Clamed.
					lvo_Conexao = Create uo_Transacao_Remota	
					lvo_Conexao.of_BancoProducao()
...
//					End If
	...
	If lb_Existe_Contrato Then
		...
		//Aqui consulta WEB service para ver se o cart$$HEX1$$e300$$ENDHEX$$o est$$HEX2$$e1002000$$ENDHEX$$ativo.
		Choose Case as_Tipo_Cartao
			Case 'UNIMED', '1'
				
				//Se o Cart$$HEX1$$e300$$ENDHEX$$o j$$HEX2$$e1002000$$ENDHEX$$foi validado n$$HEX1$$e300$$ENDHEX$$o precisa passar pelo WebService novamente
				//O RL j$$HEX2$$e1002000$$ENDHEX$$faz a valida$$HEX2$$e700e300$$ENDHEX$$o do cartao Unimed no atendimento
				...
				Try
					...
					If lo_ws.of_envia_ws( as_cartao, as_nome, Ref ls_resposta, Ref ls_erro, Ref ll_status_code ) Then
						If ls_resposta = 'N' Then
							 MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O cart$$HEX1$$e300$$ENDHEX$$o '" + as_cartao + "' n$$HEX1$$e300$$ENDHEX$$o existe ou n$$HEX1$$e300$$ENDHEX$$o est$$HEX2$$e1002000$$ENDHEX$$ativo na operadora.", Exclamation!)
							 Return False
						End If
					Else
						...
						Else				
							If ll_status_code = 404 Or ll_status_code = 500 Then //erro de conexao ou erro interno do WebService   
								 MessageBox( "Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro na Consulta com a operadora. ~n" + &
																			"Ser$$HEX2$$e1002000$$ENDHEX$$necess$$HEX1$$e100$$ENDHEX$$rio fazer a confirma$$HEX2$$e700e300$$ENDHEX$$o de documentos com o cliente." , Information!)       
							Else
								 MessageBox( "Aten$$HEX2$$e700e300$$ENDHEX$$o", "Erro consulta: " + ls_resposta +' '+ ls_erro , StopSign!)                       
								 Return False
							End If               
