...
if pl_nr_atualizacao > 0 Then
	//Interface est$$HEX2$$e1002000$$ENDHEX$$sendo executada pelo monitor de exporta$$HEX2$$e700e300$$ENDHEX$$o.
	ib_monitor_exp = True
end if
	...
	if ll_linhas  > 0 Then
		...
		For ll_linha = 1 to ll_linhas_cab
			...
			for ll_for = 1 to ll_linhas
				...
				//Verifica se a situa$$HEX2$$e700e300$$ENDHEX$$o do registro ainda est$$HEX2$$e1002000$$ENDHEX$$pendente
				...
				if ll_contador >= ii_contador_xml or ll_for >= ll_linhas Then
					...
					if ls_xml_item = '' or isnull(ls_xml_item) Then 
						ls_log	= 'XML de envio para webservice est$$HEX2$$e1002000$$ENDHEX$$em branco.'
