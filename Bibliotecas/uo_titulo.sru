...
If SqlCa.SqlCode = -1 Then
	...
	// Resgistro j$$HEX2$$e1002000$$ENDHEX$$existe na tabela	
...
If SqlCa.SqlCode <> -1 Then	
	...
	End If		
Else	
	SqlCa.of_MsgdbError("Verifica$$HEX2$$e700e300$$ENDHEX$$o do Pr$$HEX1$$f300$$ENDHEX$$ximo T$$HEX1$$ed00$$ENDHEX$$tulo $$HEX2$$e0002000$$ENDHEX$$Receber")
End If	
...
Do While Pos(ps_email, ";") > 0
	//Captura o email existente at$$HEX2$$e9002000$$ENDHEX$$o pr$$HEX1$$f300$$ENDHEX$$ximo ";"
	lvs_Email = Trim(Mid(ps_email, 1, Pos(ps_email, ";") - 1))
	//Verifica se email n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$vazio
	If Trim(lvs_Email)<>"" Then
		...
		End If
	End If
	//Exclui o email j$$HEX2$$e1002000$$ENDHEX$$adicionado no array da vari$$HEX1$$e100$$ENDHEX$$vel
...
// Parcelas $$HEX2$$e9002000$$ENDHEX$$uma vari$$HEX1$$e100$$ENDHEX$$vel de inst$$HEX1$$e200$$ENDHEX$$ncia porque a tela de vendas utiliza esta 
