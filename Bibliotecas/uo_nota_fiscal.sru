...
// Insere linhas no detalhe at$$HEX2$$e9002000$$ENDHEX$$completar 7.
...
FOR ll_row = 1 TO ll_max 
	...
	// Verifica se a linha $$HEX2$$e9002000$$ENDHEX$$menor ou igual que a quantidade de itens da nota
...
FOR lvl_linha = 1 TO ids_itens_nf.RowCount()
	...
	// Verifica se j$$HEX2$$e1002000$$ENDHEX$$foi cadastrada a mensagem fiscal na ids_mensagem fiscal
...
Choose Case SQLCA.SQLCode 
	Case -1 
		...
		Return False
	Case 0
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","J$$HEX2$$e1002000$$ENDHEX$$foi gerada uma nota fiscal deste cupom fiscal. N$$HEX1$$fa00$$ENDHEX$$mero da nota fiscal gerada : '"+String(pl_nota)+"'.", StopSign!)
		Return False
End Choose
...
// Insere linhas no detalhe at$$HEX2$$e9002000$$ENDHEX$$completar 19.
...
public subroutine imprimir_detalhe (datastore ids_report, long a_quebra, long a_linha, long a_cd_produto, string a_de_produto, long a_natureza_oper, string a_cst_produto, string a_unid_produto, long a_qt_produto, decimal a_vl_unit_produto, decimal a_pc_desc_produto, decimal a_vl_total_produto, integer a_aliq_icms);/*		 Testar no in$$HEX1$$ed00$$ENDHEX$$cio do la$$HEX1$$e700$$ENDHEX$$o de inser$$HEX2$$e700e300$$ENDHEX$$o se o MOD(linha_inserida, 12) = 0, 
		 ...
		 Cada nota deve conter 12 linhas. Caso contr$$HEX1$$e100$$ENDHEX$$rio, dar insert at$$HEX2$$e9002000$$ENDHEX$$completar as 12 linhas
...
// Insere linhas no detalhe at$$HEX2$$e9002000$$ENDHEX$$completar linhas nota fiscal
DO WHILE ll_max < (ll_quebra * lvi_Qt_Linhas_NF) 
	ll_insert = ids_report_nf.InsertRow(0)
	ids_report_nf.Object.quebra[ll_insert] = ll_quebra
	ll_linha += 1
...
// Teve que utilizar o array, porque a ordem da DS n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$por natureza
For lvl_Linha = 1 To ids_Itens_NF.RowCount()
...
public function boolean of_mensagem_impressao_nfe (string as_especie);If as_Especie = 'NFE' Then
	Messagebox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Nota fiscal eletr$$HEX1$$f400$$ENDHEX$$nica.~r~r" + "A nota dever$$HEX2$$e1002000$$ENDHEX$$ser impressa pelo sistema da NFE ap$$HEX1$$f300$$ENDHEX$$s ser autorizada pelo SEFAZ.", Exclamation!)
	Return False
End If
...
//	End If
	...
	If LenA(Trim(lvs_CEP)) <> 8 Then
		Messagebox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O CEP do cliente '" + as_Cliente + "' $$HEX2$$e9002000$$ENDHEX$$inv$$HEX1$$e100$$ENDHEX$$lido.~r~r" +&
		"A informa$$HEX2$$e700e300$$ENDHEX$$o deve ser corrigida antes da gera$$HEX2$$e700e300$$ENDHEX$$o da NFE.", StopSign!)
		Return False
	End If
...
//		Messagebox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O telefone do cliente '" + as_Cliente + "' $$HEX2$$e9002000$$ENDHEX$$inv$$HEX1$$e100$$ENDHEX$$lido.~r~r" +&
//		"A informa$$HEX2$$e700e300$$ENDHEX$$o deve ser corrigida antes da gera$$HEX2$$e700e300$$ENDHEX$$o da NFE.", StopSign!)
//		Return False
//	End If
...
Try
	...
	// Verifica se o cupom j$$HEX2$$e1002000$$ENDHEX$$gerou uma Nota fiscal
	If Not of_Verifica_Cupom(pl_filial,pl_Nota,ps_especie_cf,ps_serie_cf) Then Return
	
	// Se a vers$$HEX1$$e300$$ENDHEX$$o do sistema da NFE for maior que a 2.22 a anexa ter$$HEX2$$e1002000$$ENDHEX$$a base e valor do ICMS zerado
	...
	// L$$HEX2$$ea002000$$ENDHEX$$Nf, e verifica se existe nota digitada
	...
	// Verifica se a Nota est$$HEX2$$e1002000$$ENDHEX$$cancelada. Caso esteja cancela o processamento
	...
	// L$$HEX2$$ea002000$$ENDHEX$$os itens da Nf
	...
	//******* Sempre ser$$HEX2$$e1002000$$ENDHEX$$uma opera$$HEX2$$e700e300$$ENDHEX$$o interna - ESTADUAL ************ 
	lvl_NatOp = 5929  
