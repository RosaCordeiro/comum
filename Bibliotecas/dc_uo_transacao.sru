...
Boolean Exibe_Alerta_Commit	= True

dc_uo_dbError ivo_dbError

Private String ivs_Erro_Saida_Padrao
Protected String ivs_Datasource	= ""
Protected String ivs_Senha	= ""
Private String ivs_HostName	= ""
Private String ivs_DBMS	= ""
end variables
forward prototypes
...
public subroutine of_set_alerta_commit (boolean pb_valor)
public function boolean of_reconnect ()
public function boolean of_connect_new_trans (ref dc_uo_transacao ptr_trans)
public function string of_get_datasource ()
public function string of_get_hostname ()
public function boolean of_connect_new_trans_ini (ref dc_uo_transacao ptr_trans)
public subroutine of_set_senha (string ps_senha)
public subroutine of_set_dbms_driver (string ps_dbms)
public function string of_get_dbms_driver ()
end prototypes
...
public function integer of_commit ();If Exibe_Alerta_Commit Then
	If gvo_Aplicacao.of_Get_Alerta_Commit_Producao( ) Then 
		gvo_Aplicacao.of_Set_Alerta_Commit_Producao( (MessageBox('Aten$$HEX2$$e700e300$$ENDHEX$$o!','Voc$$HEX2$$ea002000$$ENDHEX$$est$$HEX2$$e1002000$$ENDHEX$$comitando uma transa$$HEX2$$e700e300$$ENDHEX$$o em ambiente de produ$$HEX2$$e700e300$$ENDHEX$$o.~r~nDeseja prosseguir?',Exclamation!,YesNo!,2)=2) )
		If gvo_Aplicacao.of_Get_Alerta_Commit_Producao( ) Then 
			RollBack Using This;
			Return This.SqlCode
		End If
...
if not gf_valida_dberror_auto(This.is_LastErrorText) then
	Return
end if
 ...
 * 		- N$$HEX1$$e300$$ENDHEX$$o elimina mais as conex$$HEX1$$f500$$ENDHEX$$es dos sistemas ConsultaPre$$HEX1$$e700$$ENDHEX$$o, Caixa e NFe,
		...
		- Somente o sistema TL ir$$HEX2$$e1002000$$ENDHEX$$eliminar as conex$$HEX1$$f500$$ENDHEX$$es
 */
...
public function boolean of_connect (string ps_datasource, string ps_hostname, boolean pb_mensagem);Try
	...
	//Guarda em vari$$HEX1$$e100$$ENDHEX$$veis privadas caso precisar reconectar
	ivs_Datasource				= ps_datasource
	ivs_HostName				= ps_hostname
	lo_Conexao.ivs_Senha	= ivs_Senha
...
If IsNull(Exibe_Notificacao) Then Exibe_Notificacao = Not(gvb_Auto)

//Retorna tipo de erro
If Exibe_Notificacao Then
...
public subroutine of_set_alerta_commit (boolean pb_valor);Exibe_Alerta_Commit = pb_valor
end subroutine

public function boolean of_reconnect ();If This.Of_Isconnected( ) Then 	This.Of_Disconnect( )
Return This.Of_Connect( ivs_Datasource, ivs_HostName)
end function

public function boolean of_connect_new_trans (ref dc_uo_transacao ptr_trans);//Verifica se objeto existe
If Not IsValid(ptr_trans) Then ptr_trans = Create dc_uo_transacao
//Se j$$HEX2$$e1002000$$ENDHEX$$estiver conectado ent$$HEX1$$e300$$ENDHEX$$o desconecta
If ptr_trans.Of_Isconnected( ) Then ptr_trans.Of_Disconnect( )
//Seta base de dados
ptr_trans.ivs_DataBase = This.ivs_DataBase
//Se n$$HEX1$$e300$$ENDHEX$$o estiver datasource na conex$$HEX1$$e300$$ENDHEX$$o principal, $$HEX2$$e9002000$$ENDHEX$$porque ainda n$$HEX1$$e300$$ENDHEX$$o selecionou o banco de dados em tela
If IsNull(ivs_Datasource) or (Trim(ivs_Datasource)="") Then Return False
//tenta conectar
Return ptr_trans.Of_Connect( ivs_Datasource, ivs_HostName)
end function

public function string of_get_datasource ();return this.ivs_datasource
end function

public function string of_get_hostname ();return ivs_hostname
end function

public function boolean of_connect_new_trans_ini (ref dc_uo_transacao ptr_trans);String lvs_DataBase, lvs_DataSource
String lvs_INI = "c:\sistemas\vv\exe\verifica_versao.ini"

//L$$HEX2$$ea002000$$ENDHEX$$INI para buscar o par$$HEX1$$e200$$ENDHEX$$metro essa funcionalidade $$HEX2$$e9002000$$ENDHEX$$necess$$HEX1$$e100$$ENDHEX$$ria para a loja, para a atualiza$$HEX2$$e700e300$$ENDHEX$$o do PARAMETRO_PDV
lvs_DataBase	= Upper( ProfileString(lvs_INI, "DataBase", "DataBase", "" ) )
lvs_DataSource	= ProfileString( lvs_INI, "DataBase", "DataSource", "" )

//Caso n$$HEX1$$e300$$ENDHEX$$o tenha padr$$HEX1$$e300$$ENDHEX$$o setada no INI (SelecionaBD = S)
If Trim(lvs_DataBase)="" Then lvs_DataBase = ivs_DataBase
If Trim(lvs_DataSource)="" Then lvs_DataSource = ivs_Datasource

//Caso ainda n$$HEX1$$e300$$ENDHEX$$o tenha conectado no banco de dados com o sistema e n$$HEX1$$e300$$ENDHEX$$o tenha nada no INI
If IsNull(ivs_Datasource) or ivs_Datasource="" Then Return False
...
If ptr_trans.Of_Isconnected( ) Then ptr_trans.Of_Disconnect( )
//Seta base de dados
ptr_trans.ivs_DataBase = lvs_DataBase
//tenta conectar
Return ptr_trans.Of_Connect( lvs_DataSource, gvo_Aplicacao.ivo_seguranca.cd_sistema+"_"+gvo_Aplicacao.of_userid( ))
end function

public subroutine of_set_senha (string ps_senha);This.ivs_Senha = ps_Senha
end subroutine

public subroutine of_set_dbms_driver (string ps_dbms);ivs_DBMS = ps_dbms
end subroutine

public function string of_get_dbms_driver ();Return ivs_DBMS
end function
...
event constructor;//Seta erro de saida padr$$HEX1$$e300$$ENDHEX$$o como LOG caso esteja em modo autom$$HEX1$$e100$$ENDHEX$$tico
This.of_Set_Erro_Saida_Padrao( IIF(gvb_Auto, "LOG", "MESSAGEBOX") ) 
end event
