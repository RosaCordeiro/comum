...
//					End If
	...
	If ll_Qtd_Atua = 0 Then
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Nenhum produto da lista de recolhimento foi encontrado na aprova$$HEX2$$e700e300$$ENDHEX$$o N$$HEX2$$ba002000$$ENDHEX$$" + String(dw_2.Object.Nr_Aprovacao[dw_2.GetRow()]) + ".")
		lb_Sucesso = False
		Return False
	End If
...
ElseIf ll_Linhas = 0 Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "N$$HEX1$$e300$$ENDHEX$$o existe lote cadastrado para a aprova$$HEX2$$e700e300$$ENDHEX$$o N$$HEX2$$ba002000$$ENDHEX$$'" + String(al_Aprovacao) + "'.", Exclamation!)
End If
