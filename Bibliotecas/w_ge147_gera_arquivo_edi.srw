...
If lvl_Contador > 1 Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "$$HEX2$$c9002000$$ENDHEX$$poss$$HEX1$$ed00$$ENDHEX$$vel selecionar somente um pedido por vez.", Exclamation!)
	Return False
End If
	...
	If Not IsNull(lvdh_Envio) Then
		...
		If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O pedido '" + String(lvl_Pedido) + &
				   "' j$$HEX2$$e1002000$$ENDHEX$$foi enviado em '" + String(lvdh_Envio, "dd/mm/yyyy hh:mm") + "'.~r~r" +&
...
//	End If
	...
	For lvl_Linha = 1 To lvl_Linhas
		...
		// S$$HEX2$$f3002000$$ENDHEX$$ira funcionar para a ASTRAZENECA
