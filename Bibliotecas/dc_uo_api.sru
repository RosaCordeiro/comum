...
// ps_nome_origem  = Nome Arquivo Origem
// ps_nome_destino = Nome Arquivo Destino
// pb_sobrescrever = Flag (FALSE) Subscreve j$$HEX2$$e1002000$$ENDHEX$$existente
...
For  lvl_Aux = 1 To UpperBound(lvs_Dir) 
	...
	If DirectoryExists(lvs_Dir[lvl_Aux]+'gs\') Then 
		...
		If lb_emp.DirList(lvs_Dir[lvl_Aux]+'gs\',16) Then
			//Retornou items?
			If lb_emp.TotalItems()>1 Then 											// Considera o segundo item da lista pois o primeiro $$HEX2$$e9002000$$ENDHEX$$[..]
...
If CreateProcess(ps_aplicacao,ps_parametros, lvl_null, &
	...
	If pl_timeout > 0 Then
		// Espera at$$HEX2$$e9002000$$ENDHEX$$o tempo terminar em milissegundos
		...
		End If
	Else
		// Espera at$$HEX2$$e9002000$$ENDHEX$$o processo terminar
