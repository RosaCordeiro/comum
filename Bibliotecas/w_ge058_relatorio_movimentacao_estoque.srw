	...
	Case 100
		If wf_Primeiro_Mes_Saldo(al_Filial, al_Produto, ref lvdh_Primeiro_Saldo) Then
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O saldo inicial do produto n$$HEX1$$e300$$ENDHEX$$o foi localizado.~rO primeiro " + &
										 "saldo dispon$$HEX1$$ed00$$ENDHEX$$vel $$HEX2$$e9002000$$ENDHEX$$do m$$HEX1$$ea00$$ENDHEX$$s '" + String(lvdh_Primeiro_Saldo, "mm/yyyy") + &
										 "'.~r~rSer$$HEX2$$e1002000$$ENDHEX$$considerado saldo inicial igual a zero.", Information!)
...
This.Object.Cabecalho_Periodo.Text = String(lvdt_Inicio, "dd/mm/yyyy") + "  $$HEX2$$e0002000$$ENDHEX$$" + String(lvdt_Termino, "dd/mm/yyyy")
