...
for ll_for = 1 to pds_dados.rowcount()
	...
	if ls_status = 'C' or ls_status = 'E' Then
		...
		if pb_filial_valida = False Then
			ls_situacao = 'E'
			ls_obs = 'N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$filiais v$$HEX1$$e100$$ENDHEX$$lidas vinculadas ao planograma no momento da exporta$$HEX2$$e700e300$$ENDHEX$$o.'
		else
			ls_situacao = 'P'
		end if
	...
	Else
		...
		//Se o registro n$$HEX1$$e300$$ENDHEX$$o estiver mais pendente, exclui o registro da datastore (registro n$$HEX1$$e300$$ENDHEX$$o ser$$HEX2$$e1002000$$ENDHEX$$mais usado).
...
try 
	...
	//DataStore que armazenar$$HEX2$$e1002000$$ENDHEX$$os registros da tabela de LOG de exporta$$HEX2$$e700e300$$ENDHEX$$o.
	lds = Create dc_uo_ds_base
	
	//DataStore que armazenar$$HEX2$$e1002000$$ENDHEX$$a lista de Planogramas (Vindos da tabela de LOG).
