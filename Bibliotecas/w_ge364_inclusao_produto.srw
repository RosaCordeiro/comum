...
//Verifica se j$$HEX2$$e1002000$$ENDHEX$$esta na tabela "produto_liberado_transf_perini"
	...
	Choose Case This.GetColumnName()
		Case "de_produto"
			...
			If ivo_Produto.Localizado Then
				...
				// Verifica se o produto j$$HEX2$$e1002000$$ENDHEX$$existe na lista
				...
				If ll_Find > 0 Then
					MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O produto '" + String(ivo_Produto.Cd_Produto) + "' j$$HEX2$$e1002000$$ENDHEX$$est$$HEX2$$e1002000$$ENDHEX$$na lista.", Information!)
