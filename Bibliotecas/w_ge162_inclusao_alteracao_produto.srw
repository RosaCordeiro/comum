...
Choose Case SqlCa.SqlCode
	Case 0
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O c$$HEX1$$f300$$ENDHEX$$digo '" + as_Produto + "' da distribuidora j$$HEX2$$e1002000$$ENDHEX$$est$$HEX2$$e1002000$$ENDHEX$$relacionado com o nosso c$$HEX1$$f300$$ENDHEX$$digo ~r'" + &
...
Choose Case SqlCa.SqlCode
	Case 0
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O nosso c$$HEX1$$f300$$ENDHEX$$digo '" + String(al_Produto) + "' j$$HEX2$$e1002000$$ENDHEX$$est$$HEX2$$e1002000$$ENDHEX$$relacionado com o c$$HEX1$$f300$$ENDHEX$$digo '" + &
...
If ll_Pedidos > 0 Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Esta altera$$HEX2$$e700e300$$ENDHEX$$o n$$HEX1$$e300$$ENDHEX$$o ser$$HEX2$$e1002000$$ENDHEX$$permitida pois esta gerando pedido para as distribuidoras.", Exclamation!)
...
If ldc_Med_Distribuidoras > 0 Then
	...
	If ldc_Resultado > 130 Then
		If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o",	"O valor fracionado '" + String(ldc_Vl_Compra, "#,##0.00") + "' $$HEX2$$e9002000$$ENDHEX$$superior a m$$HEX1$$e900$$ENDHEX$$dia '" +&
	...
	If ldc_Resultado < 70 Then
		If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o",	"O valor fracionado '" + String(ldc_Vl_Compra, "#,##0.00") + "' $$HEX2$$e9002000$$ENDHEX$$inferior a m$$HEX1$$e900$$ENDHEX$$dia '" +&
							String(ldc_Med_Distribuidoras, "#,##0.00") + "' das outras distribuidoras [DIFEREN$$HEX1$$c700$$ENDHEX$$A SUPERIOR A 30%].~r~rDeseja continuar mesmo assim?", Question!, YesNo!, 2) = 2 Then
...
If ll_Qtd_Emb_Padrao < 0 Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "A quantidade informada para a caixa padr$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$inv$$HEX1$$e100$$ENDHEX$$lida.")
	dw_1.Event ue_Pos(1, "qt_embalagem_padrao_distrib")
	Return
End If
