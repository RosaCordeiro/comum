...
//	ll_Loop = 0
	...
	DO WHILE Pos(as_xml_retorno, '<E_RETORNO>') > 0
		...
		as_xml_retorno = gf_Replace(as_xml_retorno, ls_Xml_Aux, '', 0)	//Limpa a parte j$$HEX2$$e1002000$$ENDHEX$$lida		
...
/*I $$HEX2$$13202000$$ENDHEX$$Inserir / E $$HEX2$$13202000$$ENDHEX$$Estornar */		'<ZTIPO_LANC>E</ZTIPO_LANC>'+&
