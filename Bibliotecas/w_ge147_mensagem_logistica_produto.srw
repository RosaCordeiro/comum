...
//Se houve altera$$HEX2$$e700e300$$ENDHEX$$o no c$$HEX1$$f300$$ENDHEX$$digo da mensagem ou se for uma inclus$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$feita a valida$$HEX2$$e700e300$$ENDHEX$$o abaixo para saber se a mensagem a ser salva j$$HEX2$$e1002000$$ENDHEX$$est$$HEX2$$e1002000$$ENDHEX$$cadastrada
	...
	Choose Case SqlCa.SqlCode
		Case 0
			If ll_Mensagem_Existe = pi_Mensagem Then
				If MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Mensagem '" + String(pi_Mensagem) + "' j$$HEX2$$e1002000$$ENDHEX$$cadastrada para o pedido '" + String(il_Pedido) + "' produto '" + String(il_Produto) + "'." + &
...
If pdh_Limite_Validade < gf_Getserverdate() Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "A data de validade informada $$HEX2$$e9002000$$ENDHEX$$menor que a data atual.~rInforme outra data.", Exclamation!)
	ps_msg_erro = "Erro ao atualizar a mensagem: " + SqlCa.SqlErrText
	Return False
End If
...
If ll_Achou > 0 Then
	MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "O XML da nota fiscal eletr$$HEX1$$f400$$ENDHEX$$nica deste pedido com este produto j$$HEX2$$e1002000$$ENDHEX$$foi importado, portanto n$$HEX1$$e300$$ENDHEX$$o ser$$HEX2$$e1002000$$ENDHEX$$poss$$HEX1$$ed00$$ENDHEX$$vel gravar uma mensagem.", Exclamation!)
	Return False
Else
	Return True
End If
...
////		If Not wf_Nivel_Alcada() Then
////			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Voc$$HEX2$$ea002000$$ENDHEX$$n$$HEX1$$e300$$ENDHEX$$o esta autorizado a fazer altera$$HEX2$$e700e300$$ENDHEX$$o na mensagem desse produto.~r~r" +&
...
If li_Ret > 0 and dw_2.rowcount() > 0 Then
	...
	If dw_2.rowcount( ) <> ll_Linhas Then
		ls_Msg = "Total de linhas do arquivo $$HEX2$$e9002000$$ENDHEX$$diferente do total de itens do pedido. Total de linhas no arquivo: "+String(dw_2.rowcount( ))+". Total de itens no pedido: "+String(ll_Linhas)
...
Choose Case ll_Mensagem
	Case 1
		...
		If ll_Qtde_Devolver > il_Qt_Pedida Then
			MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "A quantidade m$$HEX1$$e100$$ENDHEX$$xima $$HEX2$$e9002000$$ENDHEX$$"+String(il_Qt_Pedida)+".")
			dw_1.Event ue_Pos(1, "qt_devolver")		
			Return 1	
		End If
