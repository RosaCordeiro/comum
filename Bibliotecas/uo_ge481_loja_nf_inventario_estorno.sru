...
//{NR_SOLICITACAO} $$HEX2$$c9002000$$ENDHEX$$o nr_solicitacao de envio do movimento 
...
public function boolean of_log_exportacao_nao_sera_processado (ref string ps_xml, ref string ps_log);ps_log	= 'A nota que est$$HEX2$$e1002000$$ENDHEX$$sendo estornada n$$HEX1$$e300$$ENDHEX$$o foi enviada para o SAP. O documento ser$$HEX2$$e1002000$$ENDHEX$$marcado como processado autom$$HEX1$$e100$$ENDHEX$$ticamente.'
