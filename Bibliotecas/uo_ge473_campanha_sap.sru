...
Try	
	If IsNull(is_cd_campanha_sap) Or Trim(is_cd_campanha_sap) = ''  Then
		as_Log	= "O valor informado para o campo CD_CAMPANHA n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$v$$HEX1$$e100$$ENDHEX$$lido."
		Return False
	End If	

	if is_cd_campanha_sap <> is_chave_sap Then
		as_log = 'O c$$HEX1$$f300$$ENDHEX$$digo da campanha SAP $$HEX2$$e9002000$$ENDHEX$$diferente do c$$HEX1$$f300$$ENDHEX$$digo chave SAP enviado.'
		return false
	end if
	...
	Choose Case is_rede_campanha
		...
		Case Else
			...
			as_log = "O valor [" + is_rede_campanha + "] informado para o campo CD_ORG_VENDAS n$$HEX1$$e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$v$$HEX1$$e100$$ENDHEX$$lido."	
			return false
...
Try
	...
	//Controle j$$HEX2$$e1002000$$ENDHEX$$foi processado
...
Try
	...
	//Se a diferen$$HEX1$$e700$$ENDHEX$$a entre o fim do estoque minimo e o inicio da promo$$HEX2$$e700e300$$ENDHEX$$o for menor que 7 dias, o fim do estoque minimo ser$$HEX2$$e1002000$$ENDHEX$$igual ao fim da promo$$HEX2$$e700e300$$ENDHEX$$o.
...
Try
	...
	If lb_Filial Then //Promocao por Filial
		...
		if ls_chave_sap_filial <> is_chave_sap Then
			as_log = 'O c$$HEX1$$f300$$ENDHEX$$digo chave SAP do controle de filial [' + ls_chave_sap_filial + '] $$HEX2$$e9002000$$ENDHEX$$diferente do c$$HEX1$$f300$$ENDHEX$$digo chave SAP do controle de campanha [' + is_chave_sap + '].'
			return false
		end if
	...
	If lb_cidade Then
		...
		if ab_campanha_nova = True Then
			...
			If ll_achou = 0 or isnull(ll_achou) Then
				as_log = 'N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$filiais relacionados ao c$$HEX1$$f300$$ENDHEX$$digo IBGE [' + is_cd_domicilio + '] da rede [' + is_rede_campanha + '].'
				return false
			end if
	...
	If lb_UF Then //Insere por UF
		...
		if ab_campanha_nova = True Then
			...
			If ll_achou = 0 or isnull(ll_achou) Then
				as_log = 'N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$filiais relacionados a UF [' + is_uf + '] da rede [' + is_rede_campanha + '].'
				return false
			end if
...
Try
	...
	if (ll_controle_filho = 0 or isnull(ll_controle_filho) ) Then
		if ab_campanha_nova = True Then
			as_Log	= "N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$informa$$HEX2$$e700f500$$ENDHEX$$es de produto na tabela interface_sap."
			return false
		end if
	end if
	
	if ls_chave_sap_prod <> is_chave_sap Then
		as_log = 'O c$$HEX1$$f300$$ENDHEX$$digo chave SAP do controle de produto [' + ls_chave_sap_prod + '] $$HEX2$$e9002000$$ENDHEX$$diferente do c$$HEX1$$f300$$ENDHEX$$digo chave SAP do controle da Campanha [' + is_chave_sap + '].'
		return false
	end if
	...
	If lo_Comum.of_processa_carrega_dados(ll_Controle_filho, ref as_Log) Then	
		...
		For ll_Linha = 1 To lo_Comum.ids_lista_registros.RowCount()
			...
			//Armazeno o c$$HEX1$$f300$$ENDHEX$$digo do produto como est$$HEX2$$e1002000$$ENDHEX$$na DW, para utilizar no FIND mais adiante.
	...
	Choose Case SqlCa.sqlcode
		Case 0
			...
			If ( (ls_cd_uf = is_uf) or (isnull(ls_cd_uf) and isnull(is_uf)) ) & 
				...
				as_log = 'J$$HEX2$$e1002000$$ENDHEX$$existe uma Campanha com o mesmo c$$HEX1$$f300$$ENDHEX$$digo mas com UF, domic$$HEX1$$ed00$$ENDHEX$$lio fiscal ou Rede diferentes.'
				return false
...
//			End If			
		...
		Case -1
			as_Log	= "Erro ao verificar se a promo$$HEX2$$e700e300$$ENDHEX$$o $$HEX2$$e9002000$$ENDHEX$$nova. Erro: "+SqlCa.sqlErrText
			Return False
	End Choose	
