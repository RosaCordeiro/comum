...
Elseif ls_descricao <> ps_de_componente Then
	...
	//Se j$$HEX2$$e1002000$$ENDHEX$$existir atualiza a descri$$HEX2$$e700e300$$ENDHEX$$o (pode haver altera$$HEX2$$e700e300$$ENDHEX$$o de descri$$HEX2$$e700e300$$ENDHEX$$o no SAP).
...
//Verifica se a substancia j$$HEX2$$e1002000$$ENDHEX$$existe na lista gravada no banco.
...
if ll_find > 0 Then
	//Se a substancia j$$HEX2$$e1002000$$ENDHEX$$existe na lista do produto exclui a linha da datastore.
		...
		if ll_linhas > 0 Then
			...
			For ll_Linha = 1 To ll_linhas
				...
				if isnull(is_cd_componente) and isnull(is_cd_produto_sap) Then
					//Quando os campos vierem nulo $$HEX2$$e9002000$$ENDHEX$$porque deve excluir os registros relacionado ao produto vindo na chave.
					...
					if il_cd_produto > 0 then
						...
						//Excluir as substancias que existem no Sybase mas j$$HEX2$$e1002000$$ENDHEX$$n$$HEX1$$e300$$ENDHEX$$o existem no SAP.
