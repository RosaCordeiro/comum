...
public function long of_verifica_retorno (long pl_retorno);Choose Case pl_retorno
	...
	Case 3
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Sinal $$HEX2$$13202000$$ENDHEX$$Pagamento total ou sinal j$$HEX2$$e1002000$$ENDHEX$$efetuado.",StopSign!)
	Case 4
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Sinal $$HEX2$$13202000$$ENDHEX$$Valor informado inferior ao sinal m$$HEX1$$ed00$$ENDHEX$$nimo.",StopSign!)
	Case 5
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Saldo $$HEX2$$13202000$$ENDHEX$$Requisi$$HEX2$$e700e300$$ENDHEX$$o n$$HEX1$$e300$$ENDHEX$$o possui sinal ou pagamento total j$$HEX2$$e1002000$$ENDHEX$$efetuado.",StopSign!)
	Case 6
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Saldo $$HEX2$$13202000$$ENDHEX$$Valor informado diferente do saldo a receber.",StopSign!)		
	Case 7
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Total $$HEX2$$13202000$$ENDHEX$$Pagamento total ou sinal j$$HEX2$$e1002000$$ENDHEX$$efetuado.",StopSign!)		
	Case 8
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Receber Total $$HEX2$$13202000$$ENDHEX$$Valor informado diferente do Valor L$$HEX1$$ed00$$ENDHEX$$quido.",StopSign!)		
	Case 9
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Erro na comunica$$HEX2$$e700e300$$ENDHEX$$o com o servidor. O valor da Requisi$$HEX2$$e700e300$$ENDHEX$$o dever$$HEX2$$e1002000$$ENDHEX$$ser informado manualmente!",Exclamation!)		
	Case 10
		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o","Servidor em manuten$$HEX2$$e700e300$$ENDHEX$$o. O valor da Requisi$$HEX2$$e700e300$$ENDHEX$$o dever$$HEX2$$e1002000$$ENDHEX$$ser informado manualmente!",Exclamation!)		
	Case 11
...
If ls_Modo_Venda = 'O' Then // Modo or$$HEX1$$e700$$ENDHEX$$amento, n$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$estorno a realizar
	Return True
End If
...
public function boolean of_filial_em_inventario (long pl_filial_fcerta, ref boolean pb_em_inventario);/* Realiza consulta no cronograma de invent$$HEX1$$e100$$ENDHEX$$rios para retornar se a filial est$$HEX2$$e1002000$$ENDHEX$$trabalhando com or$$HEX1$$e700$$ENDHEX$$amento ou requisi$$HEX2$$e700e300$$ENDHEX$$o
	...
	Argumentos:
		...
		boolean out pb_em_inventario: True = em invent$$HEX1$$e100$$ENDHEX$$rio, False = N$$HEX1$$e300$$ENDHEX$$o est$$HEX2$$e1002000$$ENDHEX$$em invent$$HEX1$$e100$$ENDHEX$$rio
*/
Long ll_Registros
...
Try	
	...
	Choose Case ltr_Firebird.SqlCode
		...
		Case 100
			MessageBox( "Aten$$HEX2$$e700e300$$ENDHEX$$o", "Requisi$$HEX2$$e700e300$$ENDHEX$$o N$$HEX2$$ba002000$$ENDHEX$$" + String( pl_Requisicao ) + " n$$HEX1$$e300$$ENDHEX$$o localizada no F$$HEX1$$f300$$ENDHEX$$rmula Certa para a filial " + String( pl_Filial_FCerta ) + ".", StopSign! )
			pdc_Valor_Compra = 0
			Return False
...
Try
	...
	Choose Case ltr_Firebird.SqlCode
		...
		Case 100
			MessageBox( "Aten$$HEX2$$e700e300$$ENDHEX$$o", "Romaneio N$$HEX2$$ba002000$$ENDHEX$$" + String( pl_Romaneio ) + " n$$HEX1$$e300$$ENDHEX$$o localizada no F$$HEX1$$f300$$ENDHEX$$rmula Certa para a filial " + String( ll_filial_romaneio ) + ".", StopSign! )
			pdc_Valor_Taxa = 0
			Return False
			
		Case 0
			If pdc_valor_taxa <= 0 Then
				MessageBox( "Aten$$HEX2$$e700e300$$ENDHEX$$o", "Romaneio N$$HEX2$$ba002000$$ENDHEX$$" + String( pl_Romaneio ) + " da filial " + String( ll_filial_romaneio ) + " est$$HEX2$$e1002000$$ENDHEX$$sem valor de Taxa de Entrega.", StopSign! )
				Return False			
			End If
