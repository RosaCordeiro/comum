...
Try
	...
	if (ll_controle_filho = 0 or isnull(ll_controle_filho) ) Then
			...
			as_Log	= "N$$HEX1$$e300$$ENDHEX$$o h$$HEX2$$e1002000$$ENDHEX$$informa$$HEX2$$e700f500$$ENDHEX$$es contabil na tabela interface_sap."
			return false
...
Try
	...
	If lo_Comum.of_processa_carrega_dados(al_controle, ref ls_Log) Then
		...
		For ll_Linha = 1 To ll_linhas
			...
			if ll_existe > 0 Then
				ls_log = 'Registro j$$HEX2$$e1002000$$ENDHEX$$existe no banco de dados: Tabela BKPF [mandt = ' + ls_mandt + '; bukrs = ' + ls_bukrs + '; belnr = ' + ls_belnr + '; gjahr = ' + string(ll_gjahr) + '; nr_sequencial = ' + string(ll_sequencial) + ']'
				lb_sucesso = false
				return false
			end if
