...
//		//MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "J$$HEX2$$e1002000$$ENDHEX$$foi gerado o picking deste pedido para a esteira '" + string(ll_Esteira) + "'.")
//		MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "J$$HEX2$$e1002000$$ENDHEX$$foi gerado o picking deste pedido.")
//	End If
//	Return False
//End If
...
//		ls_MSG = 	"J$$HEX2$$e1002000$$ENDHEX$$foi gerado ."
//		SqlCa.of_RollBack()
//		Messagebox("Aten$$HEX2$$e700e300$$ENDHEX$$o", ls_MSG, StopSign!)
//		Return False
//	End If
...
If This.RowCount() > 0 Then 
	...
	//Essa rotina $$HEX2$$e9002000$$ENDHEX$$tempor$$HEX1$$e100$$ENDHEX$$ria, implanta$$HEX2$$e700e300$$ENDHEX$$o do sistema nos controlados
	...
	If data = 'S' Then	
		...
		If gvs_somente_controlado = 'S' Then
			If This.Object.id_situacao[row] <> 'C' and This.Object.id_situacao[row] <> 'S'  Then
				MessageBox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Somente pedido COLODADO poder$$HEX2$$e1002000$$ENDHEX$$ser selecionado.", Exclamation!)
				Return 1
			End If
		Else
...
If Not lo_finaliza.of_verifica_situacao_pedido(lvl_Filial,lvl_Pedido, Ref ls_Erro ) Then 
	Messagebox("Aten$$HEX2$$e700e300$$ENDHEX$$o", "Situa$$HEX2$$e700e300$$ENDHEX$$o do Pedido J$$HEX2$$e1002000$$ENDHEX$$esta como Terminada", Information!)
	Return
End If 
...
boolean enabled = false
string text = "D$$HEX2$$ea002000$$ENDHEX$$um duplo click para marcar todos"
